      ...
      <div class="card border-0 shadow components-section">
        <div class="card-body">
          ...
          @foreach($salesrequests as $salesrequest)
            <form method="post" action="{{ action('SalesrequestController@uploaded_cer',$salesrequest->sales_request_id)}}"
              ...
              <br><div class="row g-2">
                <div class="col-12">
                  ...
                  <div class="col-6">
                    <a href="/storage/uploads/{{ $salesrequest->cer_files }}" class="badge bg-success" target="_blank">{{ $salesrequest->cer_files }}</a>
                    <input type="file" class="form-control" name="cer_files">
                    <input type="hidden" class="form-control" name="cer_files_exist" value="{{ $salesrequest->cer_files }}">
                  </div>
                </div>
