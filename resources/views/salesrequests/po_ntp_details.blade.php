                                        ...
                                        @foreach($salesrequests as $salesrequest)
                                            <form method="post"
                                                ...
                                                <div class="approvebox"><br>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                               for="project_requirements_files">Project Requirements
                                                            1:</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <a href="/storage/uploads/{{ $salesrequest->project_requirements_files }}"
                                                               target="_blank"
                                                               class="clickable"> {{ $salesrequest->project_requirements_files }} </a>
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                               for="project_requirements_files_2">Project Requirements
                                                            2:</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <a href="/storage/uploads/{{ $salesrequest->project_requirements_files_2 }}"
                                                               target="_blank"
                                                               class="clickable"> {{ $salesrequest->project_requirements_files_2 }} </a>
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                               for="project_requirements_files_3">Project Requirements
                                                            3:</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <a href="/storage/uploads/{{ $salesrequest->project_requirements_files_3 }}"
                                                               target="_blank"
                                                               class="clickable"> {{ $salesrequest->project_requirements_files_3 }} </a>
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                               for="project_requirements_files_4">Project Requirements
                                                            4:</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <a href="/storage/uploads/{{ $salesrequest->project_requirements_files_4 }}"
                                                               target="_blank"
                                                               class="clickable"> {{ $salesrequest->project_requirements_files_4 }} </a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="approvebox"><br>
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                               for="category">Philcom Cost:</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                <a href="/storage/uploads/{{ $mark_up->mark_up_file }}"
                                                                                   target="_blank"
                                                                                   class="clickable"><b>{{$mark_up->mark_up_file}}</b></a>
                                                                            </td>
                                                                    @endforeach
                                                                </table>
                                                            </DIV>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <a href="/storage/uploads/{{ $salesrequest->po_ntp_files }}"
                                                                   target="_blank"
                                                                   class="clickable">{{ $salesrequest->po_ntp_files }}</a>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <a href="/storage/uploads/{{ $salesrequest->proposal_files }}"
                                                                   target="_blank"
                                                                   class="clickable">{{ $salesrequest->proposal_files }}</a>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <select name='project_return' class="form-control">
                                                                    ...
                                                                    <option value="Purchasing">Purchasing(Bidding)
                                                                    </option>
