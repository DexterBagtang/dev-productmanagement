              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					...
					<a href="{{ action('SalesrequestController@create') }}"><input type="submit" name="btn_add" value="ADD NEW RECORD" class="btn btn-round btn-primary"></a>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
...
{{--                              <td><a href="{{ action('BiddingController@viewLogs',$salesrequest->sales_request_id)}}" class="btn btn-primary modal-global">History</a></td>--}}
                              ...
                              <td>
                                  <a href="{{ action('SalesrequestController@edit',$salesrequest->sales_request_id)}}" class="btn btn-primary">Edit</a>
                                  <a href="{{ action('SalesrequestController@cancel_request',$salesrequest->sales_request_id)}}" class="btn btn-primary">Cancel</a>
                              </td>
                          </tr>
                          @endforeach
                      </tbody>
