                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ action('SalesrequestController@uploadfiles_details',$salesrequest->sales_request_id)}}" >
                                                <b>{{$salesrequest->sales_request_code}}</b>
                                            ...
                                            <table>
                                                <tr>
                                                    <td style="padding: 7px;">
                                                        <div <?php if ($salesrequest->contractor_ntp == '') {
                                                            echo 'class="red_td"';
                                                        } else {
                                                            echo 'class="green_td"';
                                                        }  ?> style="width:15px;height:15px;border:1px solid #000;"></div>
                                                    </td>
                                                    <td><a href="/storage/uploads/{{ $salesrequest->contractor_ntp }}"
                                                           target="_blank"><b>{{$salesrequest->contractor_ntp}}</b></a>
                                                    <td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td>
                                            <table>
                                                <tr>
                                                    <td style="padding: 7px;">
                                                        <div <?php if ($salesrequest->cer_files == '') {
                                                            echo 'class="red_td"';
                                                        } else {
                                                            echo 'class="green_td"';
                                                        }  ?> style="width:15px;height:15px;border:1px solid #000;"></div>
                                                    </td>
                                                    <td><a href="/storage/uploads/{{ $salesrequest->cer_files }}"
                                                           target="_blank"><b>{{$salesrequest->cer_files}}</b></a>
                                                    <td>
                                                </tr>
                                            </table>
                                        </td>
