                      ...
                      <div class="card uper">
                        <div class="card-body">
                          ...
                          @foreach($salesrequests as $salesrequest)
                            <form method="post" action="{{ action('SalesrequestController@cer_upload',$salesrequest->sales_request_id)}}"  enctype="multipart/form-data" class="form-horizontal form-label-left">
                              @csrf
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->po_ntp_files }}" target="_blank">{{ $salesrequest->po_ntp_files }}</a></td>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->proposal_files }}" target="_blank">{{ $salesrequest->proposal_files }}</a></td>
                              ...
                              <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="po_ntp_files">Bid Summary:</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        <thead>
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->bid_summary_files }}" target="_blank">{{ $salesrequest->bid_summary_files }}</a></td>
                          ...
                          <br><div class="approvebox">
                            ...
                            <div id ="show_files">
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bid_summary_files">CER:</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" class="form-control-file" name="cer_files">
                                <input type="hidden" class="form-control-file" name="cer_files_exist" value="{{ $salesrequest->cer_files }}">
