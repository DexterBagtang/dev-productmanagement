...
{{--                              <td><a href="{{ action('BiddingController@viewLogs',$salesrequest->sales_request_id)}}" class="btn btn-primary modal-global">History</a></td>--}}
                              ...
                              <td><a href="{{ action('SalesrequestController@approved_detail',$salesrequest->sales_request_id)}}" class="btn btn-danger"><b>{{$salesrequest->sales_request_code}}</b></a></td>
                          </tr>
                          @endforeach
                      </tbody>
                    </table>
