...
{{--                            <form method="get" action="{{ action('SalesrequestController@viewprojectstatus_usr')}}"--}}
{{--                                  enctype="multipart/form-data" class="form-horizontal">--}}
{{--                                <input type="submit" name="btn_search" value="SEARCH" class="btn btn-round btn-primary">--}}
{{--                                <label for="">Search Option :</label>--}}
{{--                                <select name='search_opt' class="form-select" required>--}}
...
{{--                            </form>--}}
                            <form method="get" action="{{ action('SalesrequestController@viewprojectstatus_usr')}}" enctype="multipart/form-data" class="form-horizontal">
