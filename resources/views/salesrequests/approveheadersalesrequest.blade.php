...
{{--                                           class="btn btn-primary modal-global">History--}}
{{--                                        </a>--}}
                                        <button type="button"
                                    ...
                                    <td class="text-danger"><strong>{{$salesrequest->status}}</strong></td>
                                    ...
                                    <td>
                                        <a href="{{ action('SalesrequestController@approved_detail',$salesrequest->sales_request_id)}}" class="btn btn-sm m-0 btn-info">
                                            Review
                                        </a>
                                    </td>
                                </tr>
