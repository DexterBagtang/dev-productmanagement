                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            ...
                            <a href="{{ action('SalesrequestController@create') }}"><input type="submit" name="btn_add"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ action('BiddingController@viewReportlogs',$salesrequest->sales_request_id)}}"
                                               class="btn btn-primary modal-global">History</a></td>
                                        ...
                                        <td>
                                            <a href="{{ action('SalesrequestController@edit',$salesrequest->sales_request_id)}}"
...
{{--                        <iframe src="https://scribehow.com/embed/Step_1__Adding_a_New_Sales_Request_Sales__q4B-jyiASOGgl6C639KLOA?as=scrollable&skipIntro=true" width="640" height="640" allowfullscreen frameborder="0"></iframe>--}}
                    </div>
                </div>
            </div>
