                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive " cellspacing="0" width="100%">
                                ...
                                @foreach($salesrequests as $salesrequest)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ action('SalesrequestController@revise',$salesrequest->sales_request_id)}}" class="btn btn-success">
                                                <i class="fa fa-refresh" style="margin-right:5px;" aria-hidden="true"></i>Revise</a>
