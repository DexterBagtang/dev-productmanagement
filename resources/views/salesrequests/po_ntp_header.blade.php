  ...
  <div class="py-4">
    <div class="d-flex justify-content-between w-100 flex-wrap">
      <div class="mb-3 mb-lg-0">
        <h1 class="h4">Sales Proposal Status</h1>
            ...
            <table id="datatable" class="table table-striped table-bordered dt-responsive " cellspacing="0" width="100%">
              ...
              @foreach($salesrequests as $salesrequest)
                <tr>
                  ...
                  <td><a href="{{ action('SalesrequestController@po_ntp_details',$salesrequest->sales_request_id)}}" class="btn btn-primary">Update</a></td>
