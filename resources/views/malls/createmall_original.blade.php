              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    @endif
                    <form method="post" action="{{ route('malls.store') }}" enctype="multipart/form-data" class="form-horizontal form-label-left">
                        <div class="form-group">
                            @csrf
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="region">Region:</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" name="region" value="{{ old('region') }}" required autofocus/>
                          </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mall_name">Mall Name:</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" name="mall_name" value="{{ old('mall_name') }}" required/>
                          </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mall_code">Mall Code:</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" class="form-control" name="mall_code" value="{{ old('mall_code') }}" required/>
                          </div>
                        </div>
                        <div class="form-group">
