              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
					...
					<a href="{{ route('register') }}"><input type="submit" name="btn_add" value="ADD NEW USER" class="btn btn-round btn-primary"></a>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive " cellspacing="0" width="100%">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td>{{$user->active}}</td>
                              <td><a href="{{ action('Auth\RegisterController@users_edit_view',$user->id)}}" class="btn btn-primary">Edit</a></td>
                          </tr>
                          @endforeach
                      </tbody>
                    </table>
