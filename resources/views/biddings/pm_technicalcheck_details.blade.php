      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Approve Philcom Proposal</h2>
...
{{--                              </div>--}}
              ...
              <?php } ?>
                ...
                <div class="approvebox"><br>
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">Philcom Proposal:</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
...
{{--                    @if($salesrequest->reason_for_revision != null)--}}
{{--                    <div class="form-group">--}}
{{--                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">Reason For Revision</label>--}}
{{--                        <div class="col-md-6 col-sm-6 col-xs-12">--}}
...
{{--                    @endif--}}
                              ...
                              <a href="{{ action('BiddingController@pm_technicalcheck_header') }}"><button type="button" class="btn btn-primary">Cancel</button></a>
                            </div>
                            </div>
                          </div>
