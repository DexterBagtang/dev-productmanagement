                                        ...
                                        @foreach($salesrequests as $salesrequest)
                                            <form method="post"
                                                ...
                                                <div class="approvebox"><br>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                               for="bid_file">Bid File:</label>
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            <a href="/storage/uploads/{{ $salesrequest->bid_file }}"
                                                               target="_blank"
                                                               class="clickable">{{$salesrequest->bid_file}}</a>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="approvebox">
                                                    ...
                                                    <div id="show_mark_up">
                                                        <div class="form-group">
                                                            <label class="control-label col-md-3 col-sm-3 col-xs-12"
                                                                   for="mark_up">Philcom Proposal: </label>
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <a href="/storage/uploads/{{ $salesrequest->mark_up_file }}"
                                                                   download
                                                                   class="clickable">{{$salesrequest->mark_up_file}}</a><input
                                                                        type="file" class="form-control-file"
                                                                        name="mark_up_file"><input type="hidden"
                                                                                                   name="existing_mark_up_file"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                <a href="/storage/uploads/{{ $salesrequest->pnl_file }}" target="_blank" class="clickable">{{$salesrequest->pnl_file}}</a>
                                                                <input type="file" class="form-control-file" name="pnl_file">
                                                                <input type="hidden" name="existing_pnl_file" value="{{$salesrequest->pnl_file}}">
                                                            </div>
                                                        </div>
