                      ...
                      <div class="card uper">
                        <div class="card-body">
                          ...
                          @foreach($salesrequests as $salesrequest)
                            <form method="post" action="{{ action('BiddingController@revenue_head_approved_markup',$salesrequest->sales_request_id)}}"  enctype="multipart/form-data" class="form-horizontal form-label-left">
                              @csrf
...
{{--                              </div>--}}
            ...
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">PM Technical Remarks :</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" class="form-control" readonly value="{{ $salesrequest->pm_remarks_yes }}">
              </div>
            </div>
            <?php } ?>
          </div>
                              ...
                              <div id ="show_pnl">
                              <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="pnl">P&L File: </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                <a href="/storage/uploads/{{ $salesrequest->pnl_file }}" target="_blank" class="clickable">{{$salesrequest->pnl_file}}</a><input type="file" class="form-control-file" name="pnl_file"><input type="hidden" name="existing_pnl_file" value="{{$salesrequest->pnl_file}}">
                              </div>
                            </div>
                          </div>
                              ...
                              <a href="{{ action('BiddingController@revenue_head_header') }}"><button type="button" class="btn btn-primary">Cancel</button></a>
                            </div>
                            </div>
                          </div>
