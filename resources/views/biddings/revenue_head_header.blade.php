  ...
  <div class="py-4">
    <div class="d-flex justify-content-between w-100 flex-wrap">
      <div class="mb-3 mb-lg-0">
        <h1 class="h4">Philcom Proposal Checking</h1>
            ...
            <table id="datatable" class="table table-bordered ">
              ...
              @foreach($salesrequests as $salesrequest)
                <tr>
                  ...
                  <td>
{{--                    <a href="{{ action('BiddingController@viewReportlogs',$salesrequest->sales_request_id)}}" class="btn btn-primary modal-global">History</a>--}}
                    <button type="button"
                  ...
                  <td><a href="{{ action('BiddingController@revenue_head_details',$salesrequest->sales_request_id)}}" class="btn btn-primary">Review</a></td>
