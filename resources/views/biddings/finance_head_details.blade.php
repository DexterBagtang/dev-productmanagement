      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <?php } if ($salesrequest->pnl_file != ""){ ?>
            <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category"> P&L File :</label>
              <div class="col-md-6 col-sm-6 col-xs-12">

            <DIV class="table-responsive">
                <table id="projectdesign" class="table table-bordered" width="100%">
                  <tr>
                  <td><a href="/storage/uploads/{{ $salesrequest->pnl_file }}" target="_blank" class="clickable"><b>{{$salesrequest->pnl_file}}</b></a></td>
