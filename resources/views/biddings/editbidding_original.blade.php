                                                                    ...
                                                                    @foreach($biddings as $bidding)
                                                                        ...
                                                                        <tr id="rowb<?php echo $b; ?>">
                                                                            <td><input type="text" class="form-control"
                                                                                       name="bid_trade[]"
                                                                                       value="{{ $bidding->bid_trade }}"/>
                                                                            </td>
                                                                            <td><input type="text" class="form-control"
                                                                                       name="contractor_name[]"
                                                                                       value="{{ $bidding->contractor_name }}"/>
                                                                            </td>
                                                                            <td><input type="text" id="currency{{$b}}"
                                                                                       class="form-control"
                                                                                       name="total_cost[]"
                                                                                       value="{{ $bidding->total_cost }}"/>
                                                                            </td>

                                                                            <td>
                                                                                <button type="button" name="remove"
                                                                                        id="{{ $b}}"
                                                                                        class="btn btn-danger btn_remove_bid">
                                                                                    X
                                                                                </button>
                                                                            </td>
                                                                        </tr>
