<nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-0 pe-2 border-bottom">
                ...
                <li class="nav-item dropdown ms-lg-3">
                    <a class="nav-link dropdown-toggle pt-1 px-0" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <div class="media d-flex align-items-center">
                            <div class="avatar rounded-circle text-center d-flex justify-content-center align-items-center
                            {{ 'bg-' . ['info', 'primary', 'secondary', 'warning', 'success', 'danger'][rand(0, 5)] }}">
                                <div class="text-uppercase fw-light">{{substr(Auth::user()->username, 0 ,1)}}</div>
                            </div>

{{--                            <div class="avatar rounded-circle bg-primary text-center d-flex justify-content-center align-items-center">--}}
{{--                                <div class="uppercase fw-light">{{substr(Auth::user()->username, 0 ,1)}}</div>--}}
{{--                            </div>--}}
{{--                            <img class="avatar rounded-circle" alt="Image placeholder" src="../../volt/assets/img/team/profile-picture-3.jpg">--}}
                    ...
                    <div class="dropdown-menu dashboard-dropdown dropdown-menu-end mt-2 py-1">
                        <a class="dropdown-item d-flex align-items-center" href="{{ action('HomeController@showChangePasswordForm') }}">
