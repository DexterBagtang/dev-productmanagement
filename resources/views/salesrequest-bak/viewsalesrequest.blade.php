                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive " cellspacing="0" width="100%">
                      ...
                      <tbody>
                          ...
                          <tr>
                              ...
                              <td><a href="{{ action('SalesrequestController@edit',$salesrequest->sales_request_id)}}" class="btn btn-primary">Edit</a><a href="{{ action('SalesrequestController@cancel_request',$salesrequest->sales_request_id)}}" class="btn btn-primary">Cancel</a></td>
                          </tr>
                          @endforeach
                      </tbody>
                    </table>
