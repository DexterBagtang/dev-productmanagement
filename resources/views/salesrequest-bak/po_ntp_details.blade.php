                      ...
                      @endforeach
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <a href="/storage/uploads/{{ $salesrequest->po_ntp_files }}" download class="clickable">{{ $salesrequest->po_ntp_files }}</a>
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <a href="/storage/uploads/{{ $salesrequest->proposal_files }}" download class="clickable">{{ $salesrequest->proposal_files }}</a>
