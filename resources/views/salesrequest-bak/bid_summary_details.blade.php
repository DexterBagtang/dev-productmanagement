                      ...
                      <div class="card uper">
                        <div class="card-body">
                          ...
                          @foreach($salesrequests as $salesrequest)
                            <form method="post" action="{{ action('SalesrequestController@bid_summary_upload',$salesrequest->sales_request_id)}}"  enctype="multipart/form-data" class="form-horizontal form-label-left">
                              @csrf
                              ...
                              <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="project_requirements_files">Project Requirements:</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <?php } ?>
                              ...
                              <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="po_ntp_files">PO / NTP:</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->po_ntp_files }}" download class="clickable">{{ $salesrequest->po_ntp_files }}</a></td>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->proposal_files }}" download class="clickable">{{ $salesrequest->proposal_files }}</a></td>
                          ...
                          <br><div class="approvebox">
                            ...
                            <div id ="show_files">
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="bid_summary_files">Bid Summary:</label>
                              <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="file" class="form-control-file" name="bid_summary_files">
                                <input type="hidden" class="form-control-file" name="bid_summary_files_exist" value="{{ $salesrequest->bid_summary_files }}">
                                <a href="/storage/uploads/{{ $salesrequest->bid_summary_files }}" download>{{ $salesrequest->bid_summary_files }}</a>
