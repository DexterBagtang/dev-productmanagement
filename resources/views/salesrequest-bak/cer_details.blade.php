                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  ...
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->po_ntp_files }}" download>{{ $salesrequest->po_ntp_files }}</a></td>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->proposal_files }}" download>{{ $salesrequest->proposal_files }}</a></td>
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                  <DIV class="table-responsive">
                                      <table id="projectdesign" class="table table-bordered" width="100%">
                                        ...
                                        <tr>
                                        <td><a href="/storage/uploads/{{ $salesrequest->bid_summary_files }}" download>{{ $salesrequest->bid_summary_files }}</a></td>
