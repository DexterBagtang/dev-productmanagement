      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="form-group">
                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="category">Mark Up:</label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <DIV class="table-responsive">
                    <table id="projectdesign" class="table table-bordered" width="100%">
                      ...
                      <tr>
                      <td><a href="/storage/uploads/{{ $mark_up->mark_up_file }}" download class="clickable"><b>{{$mark_up->mark_up_file}}</b></a></td>
                      @endforeach
                    </table>
                </DIV>
              </div>
                              ...
                              <div class="approvebox"><br>
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="proof_of_sending">Proof:</label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="file" class="form-control-file" name="proof_of_sending">
                                    <a href="/storage/uploads/{{ $salesrequest->proof_of_sending }}" download class="clickable">{{ $salesrequest->proof_of_sending }}</a>
