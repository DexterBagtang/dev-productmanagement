                                ...
                                <div class="card uper">
                                    <div class="card-body">
                                        ...
                                        @foreach($salesrequests as $salesrequest)
                                            <form method="post"
                                                  action="{{ route('projects.update', $salesrequest->project_id,$salesrequest->sales_request_id) }}"
                                                        ...
                                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                       name="sld_na"
                                                                       style="transform: scale(2);margin: 5px;"
                                                                       value="<?php echo $a; ?>">
                                                                <label class="form-check-label">
                                                                    If this field is N/A, check this box.
                                                                </label>
                                                            </div>
                                                        </div>
