...
--}}
			    ...
			    <td>{{$salesrequest->project_age}}</td>
                            ...
                            <td>{{$salesrequest->sales_request_code}}</td>
                              ...
                              <?php if ($role == '2') { ?>
                              <td><a href="{{ action('ProjectController@edit',$salesrequest->project_id)}}" class="btn btn-primary">Upload</a></td>
                            <?php } else if ($role == '3') {?>
                              <td><a href="{{ action('ProjectController@approved_project_detail',$salesrequest->sales_request_id)}}" class="btn btn-primary">Review</a></td>
                            <?php } else { ?>
                              <td></td>
                            <?php } ?>
                          </tr>
